...
const STEPS = [
  ...
  },
  {
    ...
    description: 'Customer explicitly approves purchase details before any payment session is opened.',
    icon: ShieldCheck,
  ...
  },
  {
    ...
    description: 'Razorpay Standard Checkout opens in a secure modal for UPI, cards, wallets, and netbanking.',
    icon: CreditCard,
